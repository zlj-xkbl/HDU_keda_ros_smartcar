...
pravite_nh.param("line_calib",line_calib_,1.0);
  pravite_nh.param("imu_frame", imu_frame_id_, std::string("imu_frame")); 
...
void baseBringup::velCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
  ...
  cmd_linear_x_  =  msg -> linear.x*line_calib_;
  cmd_linear_y_  =  msg -> linear.y*line_calib_;
